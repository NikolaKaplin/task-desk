      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-sm max-w-md text-center">
            Stay connected with us through our social media channels and be a
            part of the Altergemu family!
          </p>
          <div className="flex space-x-4">
            ...
            <SocialIcon
              ...
              icon={
                <FaDiscord className="text-[#7289d9] hover:text-white transition duration-200" />
              }
              label="Discord"
            />
            <SocialIcon
